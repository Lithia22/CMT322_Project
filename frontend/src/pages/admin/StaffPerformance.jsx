        ...
        if (staffResponse.ok) {
          ...
          if (staffResult.success) {
            ...
            if (complaintsResponse.ok) {
              ...
              const allComplaints = complaintsResult.success
              ...
              const allFeedbacks = feedbacksResponse.ok
                ? await feedbacksResponse
                    .json()
                    .then(r => (r.success ? r.feedbacks || [] : []))
                : [];
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-white/90">
          Welcome back, {user?.name}. Track maintenance staff performance and
          ratings
        </p>
      </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-xs text-gray-600 mb-2">
                          {staff.specialty || 'Maintenance Staff'}
                        </p>
          ...
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-600">
              {searchQuery
                ...
                : 'No maintenance staff registered yet'}
            </p>
          </CardContent>
        </Card>
      ) : (
                        ...
                        <div className="flex flex-wrap gap-1 mb-3">
                          ...
                          {staff.facility_types.length > 3 && (
                            <span className="text-xs text-gray-500">
                              +{staff.facility_types.length - 3} more
                            </span>
                          )}
                        </div>
                      )}
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-3 text-xs">
                      ...
                      <div className="text-center">
                        <div className="font-bold text-amber-600">
                          {staff.pending + staff.inProgress}
                        </div>
