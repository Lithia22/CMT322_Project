...
const ViewComplaints = () => {
  ...
  const uniqueHostels = [...new Set(mockComplaints.map(c => c.hostelName))];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold">View Complaints</h2>
        <p className="text-muted-foreground">Track and monitor all submitted hostel facility complaints</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Filters</CardTitle>
          <CardDescription>Search and filter all complaints</CardDescription>
        </CardHeader>
        <CardContent>
