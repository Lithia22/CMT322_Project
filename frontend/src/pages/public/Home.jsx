      ...
      <section className="relative min-h-[100vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="hidden lg:block relative animate-fade-in-right animate-delay-300">
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 lg:py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <h2 
              className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 animate-fade-in-up"
              style={{
                color: '#502e81'
              }}
            >
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            {/* Card 1 */}
            <div className="bg-white border-l-4 border-purple-600 shadow-lg hover:shadow-xl transition-all duration-300 hover:translate-y-[-4px] animate-fade-in-up animate-delay-100">
            ...
            {/* Card 2 */}
            <div className="bg-white border-l-4 border-purple-600 shadow-lg hover:shadow-xl transition-all duration-300 hover:translate-y-[-4px] animate-fade-in-up animate-delay-200">
              <div className="p-6 sm:p-8">
                <div className="flex items-center gap-4 mb-4">
                  <h3 className="text-lg font-bold text-gray-900 uppercase tracking-wide">
                    ADMIN REVIEW
            ...
            {/* Card 3 */}
            <div className="bg-white border-l-4 border-purple-600 shadow-lg hover:shadow-xl transition-all duration-300 hover:translate-y-[-4px] animate-fade-in-up animate-delay-300">
              <div className="p-6 sm:p-8">
                <div className="flex items-center gap-4 mb-4">
                  <h3 className="text-lg font-bold text-gray-900 uppercase tracking-wide">
                    CHECK STATUS
