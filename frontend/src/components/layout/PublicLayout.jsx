...
const PublicLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="border-b border-gray-200 bg-white/95 backdrop-blur-sm sticky top-0 z-50 shadow-sm dark:bg-slate-900/95 dark:border-gray-800">
        <div className="container mx-auto px-4">
          <div className="flex h-20 items-center justify-between">
            ...
            {/* Mobile Header - Theme toggle + Menu button side by side */}
            <div className="flex items-center gap-2 md:hidden">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-transparent"
          ...
          {/* Mobile Navigation - Only navigation links, no theme toggle */}
          {mobileMenuOpen && (
            <div className="md:hidden py-6 space-y-4 border-t border-gray-200 dark:border-gray-800">
              {navItems.map(item => {
                return (
                  <Link
                    key={item.path}
      ...
      {/* Footer */}
      <footer className="bg-purple-900 text-white mt-auto border-t-4 border-yellow-400 dark:bg-slate-900">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Logo Section */}
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <img src="/USM.svg" alt="USM Logo" className="h-12 w-12" />
                <div className="flex flex-col">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link
                    to="/"
                    onClick={() => window.scrollTo(0, 0)}
                    className="text-purple-100 hover:text-yellow-400 transition-colors duration-200"
                  >
                    Home
                  </Link>
                </li>
